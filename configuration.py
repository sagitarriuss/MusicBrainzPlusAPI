...
class MainAppConfiguration:
    ...
    def __init__(self):
        """ Read defined configuration file by the standard ConfigParser. """
    ...
    def __get_setting(self, section, key) -> str:
        """ Return any defined setting value by the section/key from the configuration file. """
    ...
    def get_db_host(self) -> str:
        """ Return configured DB Server hostname/ip-address. """
        return self.__get_setting(DB_SECTION, DB_HOST_KEY)

    def get_db_user(self) -> str:
        """ Return configured DB Server login. """
        return self.__get_setting(DB_SECTION, DB_USER_KEY)

    def get_db_password(self) -> str:
        """
        Return configured DB Server password from the separate text file defined in the application settings.
        Create default separate text file with sample password, if not found, which should be updated by the user.
        """
        pwd_value = ""
